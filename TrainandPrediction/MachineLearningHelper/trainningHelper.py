...
# Convert Sequence to X_input, y_output. Condition: n_in, n_out. Using pandas dataframe shift
# Formor information: How to Convert a Time Series to a Supervised Learning Problem in Python
...
def prepare_model(_name_to_int_set, _predictType):
    ...
    input_shape = (GVar.batch_size, GVar.n_in * _feature, GVar.encoded_length)
    print(f'Input shape for model: {input_shape}')
    model.add(LSTM(150, batch_input_shape=input_shape, stateful=True))
    if _predictType == "Activity_Performer":
