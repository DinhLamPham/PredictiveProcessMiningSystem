...
def view_xes_log_list(request):
    ...
    for idx_row, row in enumerate(row_data):
        for idx_col, col in enumerate(row):
            print(type(row_data[idx_row][idx_col]))
            if type(row_data[idx_row][idx_col]) == str:
                print(idx_col, col)
                # row_data[idx_row][idx_col] = row_data[idx_row][idx_col].replace("%20", " ")
                row_data[idx_row][idx_col] = row_data[idx_row][idx_col].replace("2020-", "2022-")
